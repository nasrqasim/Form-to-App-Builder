    ...
    return (
        <div className="min-h-screen bg-slate-50 dark:bg-gray-900 flex items-center justify-center p-4 transition-colors duration-300">
            <div className="w-full max-w-md">
                <Suspense fallback={
                    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-12 flex flex-col items-center justify-center border border-transparent dark:border-gray-700">
                        <Loader2 className="animate-spin text-indigo-600 mb-4" size={48} />
                        <p className="text-gray-500 dark:text-gray-400 font-medium">Loading login form...</p>
                    </div>
                }>
                    <LoginForm />
                </Suspense>
